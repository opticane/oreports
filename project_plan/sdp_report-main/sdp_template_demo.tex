...
\section{Video}
Your report should always contain a link to your demo video. We strongly encourage to share your video using the University SharePoint.
If you choose to use a different storage system, it should be one that will allow us to check the time of upload of the video.
...
The document should be submitted on Learn by one designed group member.

The filename must be \verb|group-[g]-userguide.pdf| where \verb|[g]| is the group number.
